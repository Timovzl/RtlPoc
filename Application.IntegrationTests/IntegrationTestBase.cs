...
public abstract class IntegrationTestBase : IDisposable
{
    ...
    public IRepository Repository => Host.Services.GetRequiredService<IRepository>();
    ...
    protected IntegrationTestBase()
    {
        ...
        ConfigureServices(services => existingHostedServices = services.Where(descriptor => descriptor.ServiceType == typeof(IHostedService)).ToHashSet());
